...
### 3. Your Photos and Prompts — Where They Go

This is important. When you submit a photo and optional text prompt for AI processing:

**Your photo and prompt are sent to third-party AI services for processing.** Specifically, we use one or more of the following depending on the project type:
...
We recommend you do not submit photos containing sensitive personal information — such as faces, identification documents, or anything you would not share with a third party.

**Your results on our servers:** Your original photo and the AI-generated result are stored on our Google Cloud servers and are deleted when you delete the project from the App.
...
- Attempt to reverse engineer, scrape, or misuse the App or its outputs
- Circumvent subscription restrictions or access controls

---

### 7. Your Content

You retain ownership of the photos you upload. By submitting a photo, you grant us (and our AI processing partners) a limited licence to process that photo solely for the purpose of generating your requested result. We do not claim ownership of your photos or results, and we do not use them to train AI models.

---

### 8. AI-Generated Results

AI outputs are not guaranteed to be accurate, suitable, or fit for any particular purpose. Results are provided as creative inspiration only. Do not rely on AI-generated designs for structural, engineering, or legal decisions.

---

### 9. Limitation of Liability

To the maximum extent permitted by Australian law, Foobar Creative is not liable for any loss or damage arising from your use of the App, including any reliance on AI-generated results, data loss, or third-party service outages.
...
If you have any questions about these Terms, please contact us at [support@renosnap.app](mailto:support@renosnap.app).
